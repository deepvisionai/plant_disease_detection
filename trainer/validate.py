...
sys.path.insert(0, 'D:/Data_Science/Cloned Gits/rwightman_efficientdet_pytorch/efficientdet-pytorch')
...
def get_net():
    ...
    checkpoint = torch.load('effdet_checkpoints/2021-02-28 19_55_41/last-checkpoint.pth')
